...
public class Main {
    ...
    static void showMeetingsFromDay(Kalendarz calendar) {
        ...
        displayMeetingsList(meetingsFromDay, "Brak spotkań w tym dniu.");
    }
    ...
    static void showMeetingsFromDayWithPriority(Kalendarz calendar) {
        ...
        displayMeetingsList(meetingsFromDayWithPriority, "Brak spotkań z podanym priorytetem w tym dniu.");
    }
    ...
    static void showMeetingsFromDayFromTime(Kalendarz calendar) {
        ...
        displayMeetingsList(meetingsFromDayFromTime, "Brak spotkań zaczynających się po podanej godzinie w danym dniu");
    }
    ...
    static void showMeetingsFromDayFromTimeToTime(Kalendarz calendar) {
        ...
        displayMeetingsList(meetingsFromDayFromTimeToTime,
                "Brak spotkań zaczynających się pomiędzy podanymi godzinami w danym dniu");
    }
    ...
    static void showMeetingsFromDayFromTimeWithPriority(Kalendarz calendar) {
        ...
        displayMeetingsList(meetingsFromDayFromTimeWithPriority,
                "Brak spotkań zaczynających się pod danej godzinie i o danym priorytecie w danym dniu");
    }

    static void displayMeetingsList(List<Spotkanie> listOfMeetings, String errorMessage) {
        if (listOfMeetings.size() == 0) {
            System.out.println(errorMessage);
        } else {
            for (int i = 0; i < listOfMeetings.size(); i++) {
                System.out.println(i + 1 + ". " + listOfMeetings.get(i));
            }
        }
    }
